...
const NAV_ITEMS = [
  ...
  { to: "/planner-checker", label: "Planer Checker", id: "planner" },
  { to: "/prism", label: "Prism", id: "prism" },
  { to: "/orbit", label: "Orbit", id: "orbit" },
  {
    label:"Analysis",
    id:"Analysis",
    children:[
      {to: "/analysis1", id:"Analysis",label:"Analysis Page 1"},
      {to: "/analysis2", id:"Analysis",label:"Analysis Page 2"}
    ]
  },
  {
    label: "Menu",
    id: "menu",
    children: [
      { to: "/main-chart", id: "MainChart", label: "Main Chart", icon: "📊" },
      { to: "/pdf-to-json", id: "PdfToJson", label: "PDF to JSON", icon: "📄" },
    ],
  },
];

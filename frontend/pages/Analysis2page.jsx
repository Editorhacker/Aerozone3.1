...
import DataTable2 from '../components/module5/DataTable';
import Filters from '../components/module5/Filter22';
import TypeCubeScene from '../components/module5/Typecubescence';
import PieCharts from '../components/module5/PieChart';
import RateSummary from '../components/module5/RateSummary';
import YearTotalQty from '../components/module5/YearTotalQty';
import SupplierPieChart from '../components/module5/SupplierPieChart';
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        const res = await fetch("https://aerozone3-1.onrender.com/api/data/analysistwo");
